...
function renderFreelance() {
  ...
  const hiddenNote = hiddenLow ? `<p class="job-company" style="margin:8px 0 0; font-size:11px; color:var(--muted);">${hiddenLow} low-fit gigs hidden (score &lt;30) • we hid 0% Datadog-type roles; lower gate or add freelance titles to see more</p>` : "";
